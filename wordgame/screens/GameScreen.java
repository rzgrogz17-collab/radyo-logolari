...
public class GameScreen extends BaseScreen implements ShowDictionaryEvent {
    ...
    private void createAndPositionShuffleButton() {
        ...
        // Sebep: createAndPositionDial() HER seviyede "stage.addActor(dial)"
        // çağırıyor, bu da dial'ı stage'in EN ÖNÜNE (üst z-sırasına) alıyor.
        // Karıştır butonu sadece 1. seviyede bir kez eklendiği için, 2.
        // seviyeden itibaren dial onun ÖNÜNE geçip dokunuşları kendisi
        // yakalıyordu (buton görünüyordu ama dokununca çalışmıyordu). Her
        // seviyede hem konumu güncel dial'a göre yeniden hesaplayıp hem de
        // toFront() ile en öne alarak bu sorun tamamen çözülüyor.
