...
public class IntroScreen extends BaseScreen{
    ...
    public void show() {
        ...
        // Kullanıcı isteğiyle: "SEVİYE: X" yazısı artık SADECE bu giriş
    ...
    private void createPlayButton(int firstIncompleteLevel){
        ...
        // Kullanıcı isteğiyle: buton artık "50. Seviye" gibi seviye
        // numarası GÖSTERMİYOR - sabit "Başlat" (ya da "to_be_continued"
        // durumunda eskisi gibi o metin) yazıyor. NOT: Bu projede Türkçe
        // (Lang_tr) ve İngilizce (Lang_en) dil dosyaları YOK (sadece kod
        // var, .properties dosyaları bu zip'in dışında) - o yüzden yeni
        // bir çeviri anahtarı EKLEYEMİYORUM. Bunun yerine, aktif dile göre
        // basit bir seçim yapılıyor: Türkçe ise "Başlat", değilse "Start".
        // Gerçek çok-dilli bir metin isterseniz .properties dosyalarınıza
        // uygun bir anahtar eklemeniz gerekir.
        if(firstIncompleteLevel == LanguageManager.locale.LevelCount){
            label = LanguageManager.get("to_be_continued");
        } else {
            label = "tr".equals(LanguageManager.getSelectedLocaleCode()) ? "Başlat" : "Start";
        }
