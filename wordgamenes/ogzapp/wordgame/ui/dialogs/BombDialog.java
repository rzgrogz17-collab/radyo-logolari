...
public class BombDialog extends BaseDialog{
    ...
    public BombDialog(float width, float height, BaseScreen screen) {
        ...
        content.setHeight(moves.getHeight() + NinePatches.play_r_up.getTotalHeight() * 4.35f);
        ...
        // Başlık panonun üst kenarına yapışıyordu; orantılı olarak içeri/aşağı alındı.
        titleContainer.setY(titleContainer.getY() - titleContainer.getHeight() * 0.32f);
        titleLabel.setY(titleContainer.getHeight() * 0.16f);
        setCloseButton();
        ...
        moves.setY(content.getHeight() * 0.42f);
