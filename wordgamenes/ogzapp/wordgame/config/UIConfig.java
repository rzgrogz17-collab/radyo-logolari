...
/**************************************************************************************************************************************************************************/
    ...
    public static final Color BWD_WORDS_TEXT_COLOR                      = Color.WHITE;
    // --> RENK DEĞİŞTİ: Kemik beyazı (ivory) yapıldı.
    public static final Color BWD_WORDS_TITLE_COLOR                     = Color.WHITE;
    // Bonus kelime listesi kutusu: daha opak, yazılar okunaklı olsun.
    public static final Color BWD_WORDS_BG_COLOR                        = new Color(0x16324FE6);
