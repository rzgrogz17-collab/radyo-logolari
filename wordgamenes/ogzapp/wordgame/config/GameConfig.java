...
public class GameConfig {
    ...
    public static final int NUMBER_OF_COINS_AWARDED_FOR_BONUS_WORDS_REWARD      = 50;
    ...
    public static final int COIN_COST_OF_USING_FINGER_REVEAL                    = 80;
     ...
     */
    public static final int NUMBER_OF_COINS_EARNED_FOR_WATCHING_VIDEO           = 50;
    ...
    /**
     * true  -> ödül video ikonu / coin bitince "Jeton" (WatchAndEarn) tablosu açılır.
     * false -> tablo hiçbir yerde çıkmaz; ikona tıklanınca doğrudan video reklam
     *          açılır, bitince mevcut "50 coin yüklendi" yazısı gösterilir.
     */
     ...
     * Alttaki 0 değerini 1 yaparsak yeni açılışta ve 24 saatte bir defa gösterilir.
     * -------->>>>>
     * public static final boolean DEBUG_LUCKY_WHEEL!!! Alakalı!
     */
    public static final int ALLOWED_SPIN_COUNT                           = 0;


    /**
     * Günlük Giriş Ödülü (7 günlük seri)
     * Uygulama her açıldığında (çark diyalogundan sonra, en fazla günde bir
    ...
    public static Map<String, Locale> availableLanguages = new LinkedHashMap<String, Locale>(){
        {
            ...
            put("af", new Locale(1000));
            put("cs", new Locale(1000));
            put("de", new Locale(1000));
            put("es", new Locale(1000));
            put("fr", new Locale(1000));
            put("id", new Locale(1000));
            put("it", new Locale(1000));
            put("nl", new Locale(1000));
            put("pl", new Locale(1000));
            put("ro", new Locale(1000));
            put("ru", new Locale(1000));
            put("tr", new Locale(10032));
            put("uk", new Locale(1000));
            put("uz", new Locale(1000));
        }
    };
